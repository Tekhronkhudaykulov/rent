  ...
  const getSimCardProcessSteps = () => {
    const steps = [
      ...
      },
      {
        ...
        detailedDescription: "Tanlangan tarif rejasi uchun to'lov xavfsiz tarzda qabul qilindi va tasdiqlandi",
      ...
      },
      {
        ...
        status: orderData.status_name.toLowerCase() === "активный" ? "completed" : "pending",
        gradient: "from-rose-500 to-pink-500",
        bgGradient: "from-rose-50 to-pink-50",
        time: orderData.status_name.toLowerCase() === "активный" ? "🎊 Tayyor!" : "⏳ Kutilmoqda",
        emoji: "🚀",
      },
    ]
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 font-medium">Buyurtmangiz holati va keyingi qadamlar</p>
              </div>
            </div>
            <div className="text-right">
              <div className="text-xs text-gray-500 mb-2 font-medium">SIM turi</div>
                    ...
                    >
                      {isCompleted ? (
                        <div className="relative">
                          ...
                          <div className="absolute -top-1 -right-1 text-xl">{step.emoji}</div>
                        </div>
                      ) : (
                        <div className="relative">
                          {step.icon}
                          {isCurrent && <div className="absolute -top-1 -right-1 text-xl">{step.emoji}</div>}
                        </div>
                      )}
                  ...
                  <div className="ml-8 flex-1">
                    ...
                    >
                      ...
                      <p
                        ...
                        ${isCompleted ? "text-emerald-600" : isCurrent ? "text-indigo-600" : "text-gray-400"}
                      `}
                      >
                        {step.description}
                      </p>
                      ...
                      {isCurrent && (
                        <div className="flex items-center mt-4 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-100">
                          ...
                          <span className="text-sm text-indigo-700 font-bold">🔄 Hozir amalga oshirilmoqda...</span>
                        </div>
                      )}
                      ...
                      {isCompleted && (
                        <div className="flex items-center mt-4 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl border border-emerald-100">
                          ...
                          <span className="text-sm text-emerald-700 font-bold">🎉 Muvaffaqiyatli yakunlandi!</span>
                        </div>
                      )}
                    </div>
                  </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-medium">Buyurtma #{orderData.id}</p>
                </div>
              </div>
              <div className="text-right">
                <div
                  className={`inline-flex items-center px-4 py-2 rounded-2xl text-sm font-bold shadow-lg ${getStatusColor(orderData.status_name)}`}
                >
        ...
        <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <div className="flex items-center mb-3">
                  ...
                  <p className="text-sm text-gray-600 font-medium">Tarif nomi</p>
                </div>
                <p className="font-black text-gray-800 text-xl">{orderData.plan.name}</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <div className="flex items-center mb-3">
                ...
                <p className="font-black text-emerald-600 text-xl">{formatPrice(orderData.plan.price)}</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <div className="flex items-center mb-3">
                  ...
                  <p className="text-sm text-gray-600 font-medium">Internet hajmi</p>
                </div>
                <p className="font-black text-blue-600 text-xl">{orderData.plan.quantity_internet} GB</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <div className="flex items-center mb-3">
                  ...
                  <p className="text-sm text-gray-600 font-medium">Amal qilish muddati</p>
                </div>
                <p className="font-black text-purple-600 text-xl">{orderData.plan.expiry_day} kun</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-8 border-2 border-white shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <p className="text-sm text-gray-600 mb-2 font-medium">👤 F.I.Sh</p>
                <p className="font-bold text-gray-800 text-lg">{orderData.client.name}</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <p className="text-sm text-gray-600 mb-2 font-medium">📱 Telefon raqami</p>
                <p className="font-bold text-gray-800 text-lg">+{orderData.client.phone}</p>
              </div>
              {orderData.client.email && (
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                  <p className="text-sm text-gray-600 mb-2 font-medium">📧 Email manzil</p>
                  <p className="font-bold text-gray-800 text-lg">{orderData.client.email}</p>
                </div>
              )}
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <p className="text-sm text-gray-600 mb-2 font-medium">💰 Hisob balansi</p>
                <p className="font-bold text-gray-800 text-lg">{formatPrice(orderData.client.balance)}</p>
              </div>
            </div>
          </div>
              ...
              {orderData.payments.map((payment) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="font-bold text-gray-800 text-lg">{payment.payment_type_name}</p>
                      <p className="text-sm text-gray-500">{formatDate(payment.created_at)}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-black text-emerald-600 text-2xl">{formatPrice(payment.amount)}</p>
                    <p className="text-sm text-emerald-500 font-bold">✅ To'landi</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 border-2 border-blue-200 shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <p className="text-sm text-gray-600 mb-2 font-medium">🚀 Faollik boshlanishi</p>
                <p className="font-bold text-gray-800 text-lg">{formatDate(orderData.date_start)}</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <p className="text-sm text-gray-600 mb-2 font-medium">⏰ Faollik tugashi</p>
                <p className="font-bold text-gray-800 text-lg">{formatDate(orderData.date_finish)}</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <p className="text-sm text-gray-600 mb-2 font-medium">📅 Buyurtma sanasi</p>
                <p className="font-bold text-gray-800 text-lg">{formatDate(orderData.created_at)}</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                <p className="text-sm text-gray-600 mb-2 font-medium">🔄 Oxirgi yangilanish</p>
                <p className="font-bold text-gray-800 text-lg">{formatDate(orderData.updated_at)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 border-2 border-purple-200 shadow-2xl">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-black text-gray-800 text-xl">{orderData.agent.name}</p>
                  <p className="text-sm text-gray-500 font-medium">Agent ID: {orderData.agent.id}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-3xl p-8 border-2 border-amber-200 shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-6">
                {orderData.cashback_amount > 0 && (
                  <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                    <p className="text-sm text-gray-600 mb-2 font-medium">🎁 Cashback</p>
                    <p className="font-black text-emerald-600 text-2xl">{formatPrice(orderData.cashback_amount)}</p>
                  </div>
                )}
                {orderData.discount_amount > 0 && (
                  <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all">
                    <p className="text-sm text-gray-600 mb-2 font-medium">🏷️ Chegirma</p>
                    <p className="font-black text-rose-600 text-2xl">{formatPrice(orderData.discount_amount)}</p>
                  </div>
                )}
              </div>
            </div>
