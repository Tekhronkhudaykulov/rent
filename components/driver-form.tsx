...
export function DriverForm({ onSubmit, onCancel }: DriverFormProps) {
  ...
  const [previewImage, setPreviewImage] = useState<string>("/turkish-driver.jpg")
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium">Фото водителя</label>
            <div className="flex items-center space-x-4">
              ...
              <div className="text-sm text-gray-600">
                <p>Нажмите на фото для изменения</p>
                <p className="text-xs">Поддерживаются: JPG, PNG</p>
              </div>
            </div>
          </div>
          ...
          {/* Full Name */}
          <div className="space-y-2">
            <label className="text-sm font-medium">Ф.И.О</label>
            <Input
